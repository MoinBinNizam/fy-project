...
if(isset($_GET['id']) && $_GET['id'] != ''){
   ...
   if($check>0){
      ...
      header('location:service_provider_add_services.php');
      die();
   } 
}
   ...
   if(isset($_GET['id']) && $_GET['id'] != ''){
      ...
      move_uploaded_file($_FILES['img']['tmp_name'],SERVICE_IMAGE_SERVER_PATH.$img);
         ...
         mysqli_query ($con, "insert into services(
            categories_id,locations_id,name,unit_price,total_price,qty,short_desc,descpt,meta_title,meta_desc,status,img , service_provider_id)
            values ('$categories_id','$locations_id','$name','$unit_price','$total_price','$short_desc','$descpt',
            '$meta_title','$meta_desc','1','$img' , '$user_id')");
         }
...
?>
<script>
    document.querySelectorAll("title")[0].innerHTML ="<?php echo $title;?>";
</script>
   ...
   <div class="animated fadeIn">
         <div class="col-lg-12">
            <div class="card">
               ...
               <h4 class="box-title"><?php echo $header; ?></h4>
               </div>
                  <form method="post" enctype="multipart/form-data">
                     ...
                     <button id="payment-button" name="submit" type="submit" class="btn btn-lg btn-info btn-block">
                        <span id="payment-button-amount"><?=$submit_button_text?></span>
                     </button>
                     <div class="field_error"> 
                  <?php echo $msg;?>
               </div>
