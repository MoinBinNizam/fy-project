...
if (isset($_POST['submit'])) {
    ...
    $sql = "INSERT INTO `order` (user_id,address,city,post_code,payment_type,total_prices,payment_status,order_status,added_on)
    ...
    foreach ($_SESSION['cart'] as $key => $val) {
        ...
        mysqli_query($con, "INSERT INTO order_detail (order_id,services_id,price)
        values ('$order_id','$key','$total_price')");
...
if (!isset($_SESSION['USER_LOGIN'])) {
    echo '<h5>You should login first</h5>';
    ...
    ?>
                            <div class="single-item">
                                ...
                                <div class="single-item__content">
                                    ...
                                    <span class="price"><?php echo ((int) $total_price) ?></span>
                                </div>
                                <div class="single-item__remove">
                                    <a href="javascript:void(0)" onclick="manage_booking('<?php echo $key ?>','remove')"><i class="icon-trash icons"></i></a>
                                </div>
                            </div>
                        <?php }?>
                        </div>
                        <div class="ordre-details__total">
                            <h5>total service price</h5>
