...
<head>
    ...
    rel="icon"
    type="image"
    href="images/icons/lendyhand-icon.jpg"
    media= "(prefers-color-scheme: light)"
    >
    <meta http-equiv="x-ua-compatible" content="ie=edge">
    <title>LendyHand - Get home service by click </title>
                ...
                <div class="col-md-6 col-lg -6 col-sm-2 col-xs-3">
                    <nav class="main__menu__nav hidden-xs hidden-sm">
                        <ul class="main__menu">
                            ...
                            <li>
                            <?php
                                if (isset($_SESSION['SERVICE_PROVIDER_LOGIN'])) {
                                    echo '<a href="logout.php">Logout</a> ';
                                } else {
                                    echo '<a href="service_provider_register.php">Be a Service provider</a>';
                                }
                                ?>
                            </li>
							<!--<li><a href="service_provider.php">Become provider</a></li>
                            -->
                        </ul>
                    </nav>
                    <div class="mobile-menu clearfix visible-xs visible-sm">
                        <nav id="mobile_dropdown">
                            ...
                            <?php }?>
                                ...
                                <li><a href="service_provider_register.php">Be a Service provider</a></li>
                ...
                <div class="col-md-3 col-lg-4 col-sm-8 col-xs-6">
                    <div class="header__right">
                        ...
                        <div class="header__account">
                            <?php
                                if (isset($_SESSION['USER_LOGIN'])) {
                                    echo '<a href="profile.php">Profile</a> <a href="my_order.php">Order</a>';
                                    ?>
                        ...
                        <div class="htc__shopping__cart">
                            ...
                            <a href="booking.php"><span class="htc__qua"><?=$totalService?></span></a>
                        </div>
                    </div>
                </div>
            </div>
