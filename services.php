                            ...
                            <div class="bradcaump__inner">
                                <nav class="bradcaump-inner">
                                  ...
                                  <a class="breadcrumb-item" href="categories.php?id=<?php echo $get_services['0']['categories_id'] ?>">
                                    <?php echo $get_services['0']['category_name'] ?></a>
                                  <span class="brd-separetor"><i class="zmdi zmdi-chevron-right"></i></span>
                                ...
                                <div class="ht__pro__desc">
                                    ...
                                    <div class="sin__desc align--left">
                                        ...
                                        <ul class="pro__cat__list">
                                            <li><a href="#"><?php echo $get_services['0']['category_name'] ?></a></li>
                                        </ul>
                                    </div>
                                    <div class="sin__desc align--left">
                                        <p><span>Location:</span></p>
                                        <ul class="pro__cat__list">
                                            <li><a href="#"><?php echo $get_services['0']['location_name'] ?></a></li>
                                        </ul>
                                    </div>

                                    </div>
                                    
                                <a class="fr__btn" href="javascript:void(0)" onclick="manage_booking('<?php echo $get_services['0']['id'] ?>','add')">Book Now</a>
                                </div>
                                <div class="sin__desc align--left">
                                        <p><span>Service Provider:</span></p>
                                        <ul class="pro__cat__list">
                                            <li><a href="#"><?php echo $get_services['0']['provider_name'] ?></a></li>
                                        </ul>
                                </div>
